...
const guessType = (restaurant, title, description) => {
  ...
  const model = {
    formule: 'formule|menu',
    kebab: 'sandwich kebab|sandwich grec',
    biryani: 'biryani',
    tenders: 'tenders',
    ...
    milkshake: 'milkshake',
    wine: 'vin en pichet|pichet de vin|vin blanc|vin rouge|vin rosé|bordeaux|pinot|chardonnay|(?:rosé|cote) de provence|chablis|beaujolais|chianti|chiaretto',
    champagne: 'champagne',
    ...
    dessert: 'maaamoul|gulab jamun|(?:succulent|fondant|mousse|tarte) au chocolat|tiramisu|pann?a ?cott?a',
    coke: 'coca(?: |-)?cola|breizh cola|pepsi cola|coca|pepsi|coke',
    sparklingwater: 'badoit|san pellegrino|perrier',
    smoothie: 'smoothie',
    juice: 'jus (?:de |d\')?(?:ananas|pomme|fraise|orange)',
    drink: 'schweppes|fanta|tropico|limonade|citronnade|dr pepper|7 ?up|oasis|orangina|sprite|ice ?tea|jarrito|lassi',
    water: 'eau plate|volvic|cristaline|evian|vittel',
    croissant: 'croissant',
